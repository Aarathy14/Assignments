    ...
    return (
     <div>
      <div className='text-center m-3 p-3'>
       ...
       <div className='m-5'><button className='ti' onClick={ this.handleCreate}>Sign In</button></div>
       </div>
       ...
       <div className='m-5'> <input type='text' placeholder='Password'></input><br/></div>
        <div className='m-5'><button className='or' onClick={ this.handleCreate}>Create Account</button></div>
        </div></div>
        </div>
    )
  }
