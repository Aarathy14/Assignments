...
handletoggle=(e)=>{this.setState({show:!this.state.show})}
handledelete=(i)=>{
  ...
  return (
    <div className='a'>
       ...
       <div className='c'>
               ...
               <div>
               <p>{this.state.show?data.info :data.info.slice(0,200)} <button className="btn btn-secondary" onClick={this.handletoggle}>{this.state.show?"show less":"show more"}</button>
               </p>
